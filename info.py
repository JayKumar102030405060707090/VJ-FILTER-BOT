...
API_ID = int(environ.get('API_ID', '28609964'))
API_HASH = environ.get('API_HASH', '3236bdf1e11a0fb8091495e083857621')
BOT_TOKEN = environ.get('BOT_TOKEN', "7642271614:AAG4QWpg1sXQhZVSOu0OvmgkfPwygvkb8BA")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/9a24da4c42b10e53364a3-efa5e8ab93c0cea435.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7168729089').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002280173834'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002351186360').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002006159361') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002187301776')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002316132213')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002482065387')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002439995690').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://morejaydip68:p70n6TFsTsChq3YX@cluster0.oh9nr.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "morejaydip68")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Your_Movie_Area')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/yourmoviesareaupdates')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Your_Movie_Area') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/INNOCENT_FUCKER')
